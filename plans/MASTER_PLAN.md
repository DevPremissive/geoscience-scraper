...
| **Tenure** | **VERY STRONG (spatially), PARTIALLY TEMPORAL** | ON **1.36 M** polygons — 681,350 across 5 OGSEarth layers *plus* the MLAS bundle's 401,704 cell claims, 431,584 cancelled, 193,755 non-mining, 22,940 tenure, 16,812 alienations, 800 plans/permits (the ON figures previously here were derived from a damaged snapshot — audit I12); YT 244,703 historical + 168,481 quartz + 33,934 placer; NU 34,411 + leases/permits; BC 42,285; NB; **NS 2,227 (newly readable)**; NT. Ontario now has real history via the cancellation register; **everywhere else is still current-registry only — see gap #10** |
...
| 16 | **The Ontario tenure harvest is the wrong product** — the KMZ carries no `HOLDER`, no dates and no cancellation register | ON ownership, expiry, heat and buyer work have no input from the KMZ | **C0.1** | **CLOSED 2026-08-14.** MLAS registered and harvested; 401,704 claims with all four attribute fields 100% populated. ~~"undercounts by ~50%"~~ **withdrawn — that was our own damaged snapshot, not the product (audit I12).** A complete KMZ harvest yields 401,705 claims, one apart from MLAS. The product argument stands on attributes alone |
